...
class NavigationTypes extends React.Component {
  ...
  constructor(props) {
    ...
    NotificationsAndroid.addEventListener('remoteNotificationsRegistered', this.onPushRegistered.bind(this));
		NotificationsAndroid.addEventListener('remoteNotificationsRegistrationFailed', this.onPushRegistrationFailed.bind(this));
...
componentWillUnmount() {
    ...
    NotificationsAndroid.removeEventListener('remoteNotificationsRegistered', this.onPushRegistered.bind(this));
  NotificationsAndroid.removeEventListener('remoteNotificationsRegistrationFailed', this.onPushRegistrationFailed.bind(this));
}
